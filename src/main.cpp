...
uint256 hashGenesisBlock("0x000000a008d9ee91ccfd9eec6937aa1efd51171c6842bac0638f411e18968972");
static const unsigned int timeGenesisBlock = 1523681506;
static const unsigned int nNonceGenesisBlock = 80690712;
...
const string strMessageMagic = "DreamWorld Signed Message:\n";
...
static const int64 nPmCoin = 100000000  *  COIN;
static const int64 nStartCoin = 10 * COIN;
static const int64 nTargetTimespan = 60 * 60 * 24;  // retarget every 1 day
static const int64 nTargetSpacing = 120; // 2 min
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "D-9000-W";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
       ...
       // set to true to mine genesis block
        ...
        assert(block.hashMerkleRoot == uint256("0xe344baee40e1cf11a4d47cc55020c9fdbdd259cf2491f6c026aac7d0b5d4bc69"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DreamWorldMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DreamWorldMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("DreamWorldMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("dreamworld-miner");
    ...
    try { while(true) {
        ...
        printf("Running DreamWorldMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("DreamWorldMiner terminated\n");
        throw;
    }
}

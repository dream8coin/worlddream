...
const QString BITCOIN_IPC_PREFIX("dreamworld:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click dreamworld: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start dreamworld: click-to-pay handler");
    else
...
{
    // clicking on dreamworld: URLs creates FileOpen events on the Mac:
